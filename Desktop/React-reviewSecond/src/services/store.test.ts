...
import orderReducer, { OrderState } from './page-constructor/order/slice';
import userReducer, { UserState } from './page-constructor/user/slice';

import burgerConstructorReducer, {
  burgerConstructorState
} from './page-constructor/burger-constructor/slice';

import feedReducer, { FeedState } from './page-constructor/feed/slice';
import ingredientsReducer, {
  IngredientsState
} from './page-constructor/ingredients/slice';
